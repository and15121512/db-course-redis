...
print(f'SET time: {end_set - start_set:0.4f} seconds')
print(f'GET time: {end_get - start_get:0.4f} seconds')

print('Output example: '+str(r.get(str(1))))
